...
<div class="button-row">
  {% include button.html text="All publications" link="/publications/?search=" style="bare" %}
  ...
  {% include button.html text="Patents" link="/publications/?search=%22tag:%20patents%22" style="bare" %}
</div>

<!-- {% include search-box.html disabled=true %} -->
